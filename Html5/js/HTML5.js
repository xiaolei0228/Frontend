...
/**
 ...
 @const
 */
CanvasContext.prototype.canvas = 0;
/**
 @type Number
 */
CanvasContext.prototype.globalAlpha = 0;
/**
 @type String
 */
CanvasContext.prototype.globalCompositeOperation = 0;
CanvasContext.prototype.fillStyle = 0;
CanvasContext.prototype.strokeStyle = 0;
/**
 @type Number
 */
CanvasContext.prototype.lineWidth = 0;
/**
 @type String
 */
CanvasContext.prototype.lineCap = 0;
/**
 @type String
 */
CanvasContext.prototype.lineJoin = 0;
/**
 @type Number
 */
CanvasContext.prototype.miterLimit = 0;
/**
 @type Number
 */
CanvasContext.prototype.shadowOffsetX = 0;
/**
 @type Number
 */
CanvasContext.prototype.shadowOffsetY = 0;
/**
 @type Number
 */
CanvasContext.prototype.shadowBlur = 0;
/**
 @type String
 */
CanvasContext.prototype.shadowColor = 0;
/**
 @type String
 */
CanvasContext.prototype.font = 0;
/**
 @type String
 */
CanvasContext.prototype.textAlign = 0;
/**
 @type String
 */
CanvasContext.prototype.textBaseline = 0;
...
/**
 ...
 @param {Number} dy
 */
CanvasContext.prototype.transform = function(m11,m12,m21,m22,dx,dy) {};
/**
 @param {Number} m11
 @param {Number} m12
 @param {Number} m21
 ...
 @param {Number} dy
 */
CanvasContext.prototype.setTransform = function(m11,m12,m21,m22,dx,dy) {};
/**
 @param {Number} x0
 @param {Number} y0
 @param {Number} x1
 ...
 */
CanvasContext.prototype.drawFocusRing = function(element,xCaret,yCaret,canDrawCustom) {};
/**
 @param {String} text
 @param {Number} x
 @param {Number} y
...
/**
 ...
 @param {Number} [dh]
 */
CanvasContext.prototype.drawImage = function(img_elem,dx_or_sx,dy_or_sy,dw_or_sw,dh_or_sh,dx,dy,dw,dh) {};
/**
 @param {ImageData|Number} imagedata_or_sw
 @param {Number} [sh]
 @return ImageData
 */
CanvasContext.prototype.createImageData = function(imagedata_or_sw,sh) {};
/**
 @param {Number} sx
 @param {Number} sy
 @param {Number} sw
 ...
 */
CanvasContext.prototype.putImageData = function(image_data,dx,dy,dirtyX,dirtyY,dirtyWidth,dirtyHeight) {};
CanvasContext = {};
